...
// 缩略图的支持
void CtuxingDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CtuxingDoc::InitializeSearchContent()
{
...
void CtuxingDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
